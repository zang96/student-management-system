...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into `tables` (full_name, sex, house_address, institution, graduate_undergraduate, `email`, `phone_number`) values('$fullName', '$genders', '$houseAddress', '$institution', '$grade_undergrade', '$email', '$phoneNumber')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    ...
                    <span><p class="love">Made with <ion-icon name="heart" class="text-danger"></ion-icon> by dev_zang</p></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
