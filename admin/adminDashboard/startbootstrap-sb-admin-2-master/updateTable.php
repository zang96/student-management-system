...
if (isset($_POST['submit'])) {
    ...
    $sql = "update `tables` set id=$id, full_name='$fullName', sex='$genders', house_address='$houseAddress', institution='$institution', graduate_undergraduate='$grade_undergrade', email='$email', phone_number='$phoneNumber'";
